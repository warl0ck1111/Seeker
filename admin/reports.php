						 ...
						 <?php foreach ($seekers as $key => $seeker) : ?>
							<?php  ?>
 							<tr >
								 ...
								 <td>
 									<a class="fa fa-block btn suspend" href="reports.php?suspend-seeker=<?php echo $seeker['reported_user_id'] ?>">
 									</a>
								 </td>
								 <td>
 									<a class="fa fa-unblock btn unsuspend" href="reports.php?unsuspend-seeker=<?php echo $seeker['reported_user_id'] ?>">
 									</a>
 								</td>
 							</tr>
 						<?php endforeach ?>
